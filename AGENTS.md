...
C0-PRICE-BRIDGE-INTEGRITY, C1-FIXED-SAMPLE-ADMISSION-ORCHESTRATION, C2-MINIMAL-DISTRIBUTION-RESEARCH-CONTRACT and C3-RESEARCH-PLATFORM-FOUNDATION are frozen. M1-FIXED-SAMPLE-RESEARCH-WORKBENCH is complete as a machine-verifiable research workbench: AC1-AC10 passed, all investment conclusions remain `conditional_research_only`, and formal G3/event materiality reviews are deferred to M3/M5. There is no automatically active milestone now; M2 requires an explicit user launch after M1 review. The former standalone C4 adapter proposal was absorbed into M1, not a competing goal or a sufficient completion condition.
