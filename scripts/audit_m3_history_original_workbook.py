#!/usr/bin/env python3
"""Recompute acceptance evidence for the M3 history overlay workbook."""
...
from value_investment_agent.m3_history_original_workbook_acceptance_audit import (  # noqa: E402
...
DEFAULT_WPS_RECEIPT = (
    ROOT / "runtime" / "m3-history-overlay-wps-20260924" / "wps-verification.json"
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json_only:
        ...
        return 0
    print(f"M3 history overlay acceptance status: {receipt['status']}")
