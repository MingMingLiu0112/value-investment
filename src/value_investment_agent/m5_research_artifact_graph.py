...
_KIND_BY_ARTIFACT = {
    ...
    # A valuation result is the concrete bounded-recalculation target when its
    # inputs change; it is not treated as a new intrinsic-value conclusion.
    ARTIFACT_VALUATION_RESULT: KIND_VALUATION_INPUTS,
