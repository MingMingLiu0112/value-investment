...
ARTIFACT_DECISION_EVIDENCE_BUNDLE = "decision_evidence_bundle"
ARTIFACT_MINIMAL_PORTFOLIO_PRECONDITIONS = "minimal_portfolio_preconditions"
ARTIFACT_INVESTMENT_DECISION_REVIEW = "investment_decision_review"
ARTIFACT_ENTRY_THESIS_SNAPSHOT = "entry_thesis_snapshot"
ARTIFACT_DECISION_JOURNAL_ENTRY = "decision_journal_entry"
...
_SCOPE_ALLOWLIST: dict[str, frozenset[str]] = {
    ...
    ARTIFACT_FINANCIAL_FACTS: frozenset({SCOPE_SECURITY}),
    ...
    ARTIFACT_DECISION_EVIDENCE_BUNDLE: frozenset({SCOPE_SECURITY}),
    ARTIFACT_MINIMAL_PORTFOLIO_PRECONDITIONS: frozenset({SCOPE_REVIEW}),
    ARTIFACT_INVESTMENT_DECISION_REVIEW: frozenset({SCOPE_SECURITY}),
    ARTIFACT_ENTRY_THESIS_SNAPSHOT: frozenset({SCOPE_SECURITY}),
    ARTIFACT_DECISION_JOURNAL_ENTRY: frozenset({SCOPE_SECURITY}),
    ARTIFACT_INVESTMENT_CONSISTENCY_REVIEW: frozenset({SCOPE_SECURITY}),
}
