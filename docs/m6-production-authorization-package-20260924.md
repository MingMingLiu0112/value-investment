...
- SSE/SZSE、20 个连续真实交易会话、至少 1 件真实财务/资本配置事件；四方候选签名与第五方 admission 签名互异，每个事件另由第五方签收并包外钉住精确 Hash，历史/合成不计数；
...
| 官方日历/Shadow | SSE 2026 休市公告及 SZSE 月度日历均已归档、独立重取核对；已验真实会话 0 | 明确授权交易所范围并绑定对应日历、会话运行收据、连续 20 日及真实事件标准 |
