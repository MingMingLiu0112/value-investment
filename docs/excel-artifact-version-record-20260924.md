...
| 文件 | 字节数 | SHA-256 | 最近提交 |
| --- | ---: | --- | --- |
| A股价值投资_M5真实披露待复核队列_20260924.xlsx | 13,130 | 58b16bf00dd7ea57ee9cdcd6d7d7d00d80c0fc9669cd047f5171f500a9b16ec5 | 本轮 M5 真实披露队列 |
...
- 受跟踪工作簿：13 个，均已推送到公开仓库；最新一次 Excel 新增为 M5 材料性接入候选，
  对应提交 `1017f1d`。
- WPS 云盘比对：13 个同名工作簿字节数与 SHA-256 与仓库工作树一致。
